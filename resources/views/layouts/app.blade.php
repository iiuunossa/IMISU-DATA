...
<body> 
  ...
  <div class="container">
     <a class="navbar-brand" href="{{ url('/home') }}"> IMISU-DATA </i></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Service logs</a>
                </li>
                </li>
                <!-- <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Service Logs
                    </a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Administration
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="{{ url('/crsh') }}">Applications</a></li>
            ...
            <form class="d-flex">
                ...
                <button class="btn my-2 my-sm-0 text-dark" type="submit" value="Logout"><i class="fa fa-sign-out"></i></button>
        </div>
    </div>
</nav>     
    @yield('content')
